...
@Suppress("NAME_SHADOWING")
fun generateLongArray(length: Int, seed: Long, func: (index: Int, seed: Long) -> Long): LongArray {
...
@Suppress("NAME_SHADOWING")
fun generateIntArray(length: Int, seed: Int, func: (index: Int, seed: Int) -> Int): IntArray {
